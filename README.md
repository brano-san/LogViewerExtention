...
При открытии файла .json или .jsonlog форматирование применяется автоматически для файлов (Набор расширений с автоматическим форматированием можно изменить в настройках)
До:
```cpp
